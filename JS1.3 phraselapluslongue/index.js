...
for (let i = 0; i < phrases.length; i ++ ) {
    ...
    // Si la longueur de phraseLaplusLongue est inferieur a la phrase actuelle alors phraseLaPlusLongue === phraseactuelle
    
    if(phraseLaPlusLongue.length < phrases[i].length ) {
...
console.log(phraseLaPlusLongue, phraseLaPlusLongue.length);